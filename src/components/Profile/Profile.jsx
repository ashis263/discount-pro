    ...
    return (
        <div className="">
            <div className="bg-primary pt-5 pb-28 sm:pt-10 sm:pb-36 lg:pb-52 space-y-3 text-gray-200 text-center mb-5 sm:mb-10">
                <h3 className="w-2/3 lg:w-1/2 mx-auto text-2xl sm:text-4xl font-bold">Welcome to Discount Pro</h3>
            ...
            <div className="w-2/3 lg:w-1/2 rounded-xl mx-auto text-center relative -top-16 sm:-top-24 lg:-top-40 bg-white shadow-lg">
